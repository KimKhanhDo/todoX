...
function TaskCard({ task, index, handleTaskChanged }) {
    ...
    const deleteTask = async (taskId) => {
        try {
            ...
            toast.error('Error occurred when deleting task.');
        }
    };
    ...
    const updateTask = async () => {
        try {
            ...
            console.error('Error occurred when updating task.', error);
            toast.error('Error occurred when updating task.');
        }
    };
    ...
    const toggleTaskCompleteButton = async () => {
        try {
            if (task.status === 'active') {
                ...
                toast.success(`${task.title} is waiting for you to complete`);
            }

            handleTaskChanged();
        } catch (error) {
            console.error("Error occurred when updating task's status.", error);
            toast.error("Error occurred when updating task's status.");
        }
    };
